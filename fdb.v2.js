...
function FDB(){
   ...
   this.CollectionDataGet = function( request_params ){
      ...
      var search_type = request_params.request_data.search_type;
      ...
      if( IsEmpty( collection_filter ) ){
         ...
         query = GetQuery( collection_filter, search_type );
      }//if
   ...
   function GetQuery( collection_filter, search_type ){
      ...
      switch( search_type ){
         case SEARCH_TYPES.UNDEF:
            query = { name: new RegExp( value, 'g' ) };
            break;
         
         case SEARCH_TYPES.BY_NAME:
            query = { name: new RegExp( value, 'g' ) };
            break;
         
         case SEARCH_TYPES.BY_TEXT:
